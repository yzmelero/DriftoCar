...
public class DriftoCarApplication {
	...
	public static void main(String[] args) {
		...
		Agent agent = new Agent("63535312A", "admin", "admin", "administrador", "apellidoAdministrador",
				"adminDefault@gmail.com", "654993670", "AdminLandia", "a1", LocalDate.parse("2024-12-12"),
				LocalDate.parse("2024-12-12"), "766737631552", "La calle del Admin", false, null, TipusRol.ADMIN,
				localitzacio);
		agentService.altaAgent(agent);

		Agent agent2 = new Agent("99462678G", "agent", "agent", "agente", "apellidoAgente",
				"agenteDefault@gmail.com", "640189094", "AgenteLandia", "g1", LocalDate.parse("2024-12-12"),
				LocalDate.parse("2024-12-12"), "38475621001893", "La calle del agente", false, null, TipusRol.AGENT,
				localitzacio2);
